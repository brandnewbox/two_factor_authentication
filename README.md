...
BNB has forked this gem because the original has not had an update since 2019 and it no longer works with newer versions of Rails and has some issues working in engines.
